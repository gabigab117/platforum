def welcome_message(user):
    return (f"Bienvenu(e) {user.username} !\n"
            ...
            f"Pour bien utiliser le constructeur de forum n'hésites pas à aller voir la documentation (lien)\n"
            f"Tu peux évidemment supprimer cette catégorie test dès à présent pour créer le forum à ton image et à l'image du thème choisi.")
