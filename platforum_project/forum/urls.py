...
from .views import create_forum, index, sub_category_view, add_topic, topic_view
...
urlpatterns = [
    ...
    path('<str:slug_forum>/<int:pk>/<str:slug_sub_category>/<int:pk_topic>/<str:slug_topic>', topic_view, name="topic"),
]
